"""
src/deep-learning-model.py

Deep learning baseline entrypoint (backwards-compatible wrapper around `src/models.py` and `src/features.py`).
"""
...
from models import DeepTrajectoryNetwork
